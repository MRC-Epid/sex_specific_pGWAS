...
--keep /insert_path/sex-specific-pGWAS/input/Fenland_women_only_samples_keep.txt \
...
--geno 0.05 \
--out /insert_path/sex-specific-pGWAS/output/Fenland_trait_of_interest_women_only
