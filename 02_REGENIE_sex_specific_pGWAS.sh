...
--keep /insert_path/input/UKBB_Olink_women_only.txt \
...
--out step1_UKBB_Olink/fit_bin_out_UKBB_Olink_step1
...
--threads 30 \
--gz \
--pred step1_UKBB_Olink/fit_bin_out_UKBB_Olink_step1_pred.list \
--out output/UKBB_trait_of_interest_women_only_chr"$NUMBER"; done
